...
var Essential_Audio = (() => {
    ...
    function E(a) {
        ...
        var vc = a.zd.substr(a.zd.length - 3, a.zd.length);
        vc = vc.toLowerCase();
        var vd = f;
    ...
    function Y() {
        var vt = document.querySelectorAll("iframe");
        vt.forEach((vr, ib) => {
            if (vr.contentWindow) {
                vr.contentWindow.postMessage("{\"event\":\"command\",\"func\":\"pauseVideo\",\"args\":\"\"}", "*")
            }
        })
    }
})();